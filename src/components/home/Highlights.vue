  ...
  <section>
    <div class="py-16 overflow-hidden lg:py-24">
      <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
        <svg class="hidden lg:block absolute left-full transform -translate-x-1/2 -translate-y-1/4 opacity-50" width="404" height="784" fill="none" viewBox="0 0 404 784">
          <defs>
  ...
  <span class="text-gradient bg-gradient-l-ocean-dark">theme</span><span class="text-cool-gray-500">:</span> <span class="text-cool-gray-400">{</span>
    ...
    <span class="text-gradient bg-gradient-l-ocean-dark">extend</span><span class="text-cool-gray-500">:</span> <span class="text-cool-gray-400">{</span>
      <span class="text-gradient bg-gradient-l-ocean-dark">colors</span><span class="text-cool-gray-500">:</span> <span class="text-cool-gray-400">{</span>
        <span class="text-gradient bg-gradient-l-ocean-dark">blue</span><span class="text-cool-gray-500">:</span> <span class="text-cool-gray-400">{</span>
          <span class="text-gradient bg-gradient-l-ocean-dark">brand</span><span class="text-cool-gray-500">:</span> <span class="text-green-400">'#286dbd'</span><span class="text-cool-gray-500">,</span>
        <span class="text-cool-gray-400">}</span><span class="text-cool-gray-500">,</span>
      <span class="text-cool-gray-400">}</span><span class="text-cool-gray-500">,</span>
      <span class="text-gradient bg-gradient-l-ocean-dark">spacing</span><span class="text-cool-gray-500">:</span> <span class="text-cool-gray-400">{</span>
        ...
        <svg class="hidden lg:block absolute right-full transform translate-x-1/2 translate-y-12 opacity-50" width="404" height="784" fill="none" viewBox="0 0 404 784">
          <defs>
