    ...
    <header class="flex flex-wrap lg:flex-no-wrap fixed top-0 lg:h-24 w-full bg-white border-b border-gray-300 z-10">
      <div class="flex flex-no-shrink items-center justify-between bg-gradient-l-ocean-light px-6 py-2 lg:p-6 lg:pr-16 w-full lg:max-w-xs">
        ...
        <div class="flex flex-col lg:flex-row items-center lg:justify-between w-full">
          ...
          <a :href="$static.releases.edges[0].node.url" target="_blank" rel="noopener" class="hidden lg:flex text-blue-300 border border-blue-300 hover:text-blue-500 hover:bg-white hover:border-white rounded text-xs px-4 py-px shadow transition-colors duration-300">
      ...
      <div :class="{'hidden': !showSearch, 'mt-14': showSearch}" class="overflow-y-auto lg:overflow-visible lg:flex h-full fixed lg:relative lg:h-auto bg-gradient-l-ocean-light lg:bg-image-none items-center lg:px-16 xl:px-20 w-full lg:max-w-3xl">
        <div class="relative w-4/5 lg:w-full mx-auto">
          <input type="search" id="search" ref="search" class="placeholder-white lg:placeholder-gray-500 text-gray-500 lg:text-black -mt-px appearance-none bg-transparent lg:bg-white block h-24 outline-none pl-8 transition-all duration-300 w-full" placeholder="Search documentation..." name="search" autocomplete="off" />
