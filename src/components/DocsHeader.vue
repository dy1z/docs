<template>
  <div>
    <header class="flex flex-wrap lg:flex-no-wrap fixed top-0 lg:h-24 w-full bg-white border-b border-gray-300 z-10">
      ...
      <div :class="{'hidden': !showSearch, 'mt-14': showSearch}" class="overflow-y-auto lg:overflow-visible lg:flex h-full fixed lg:relative lg:h-auto bg-gradient-l-ocean-light lg:bg-image-none items-center lg:px-16 xl:px-20 w-full lg:max-w-3xl">
        <div class="relative w-4/5 lg:w-full mx-auto">
          <input type="search" id="search" ref="search" class="placeholder-white lg:placeholder-gray-500 text-gray-500 lg:text-black -mt-px appearance-none bg-transparent lg:bg-white block h-24 outline-none pl-8 transition-all w-full" placeholder="Search documentation..." name="search" autocomplete="off" />
          <div class="absolute flex items-center inset-y-0 text-gray-500">
      ...
      <div class="hidden lg:flex items-center xl:px-6 xl:-mx-6">
        <a href="https://github.com/maizzle" class="text-gray-500 hover:text-gray-600 px-6" target="_blank" rel="noopener nofollow">
          <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-labelledby="gh-title" role="img">
        ...
        <a href="https://twitter.com/maizzlejs" class="text-gray-500 hover:text-gray-600 px-6" target="_blank" rel="noopener nofollow">
          <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-labelledby="tw-title" role="img">
        ...
        <a href="https://themeforest.net/user/thememountain/portfolio" class="text-gray-500 hover:text-gray-600 px-6" target="_blank" rel="noopener nofollow">
          <svg class="w-5 h-5 fill-current" viewBox="0 1 20 24" xmlns="http://www.w3.org/2000/svg" aria-labelledby="evt-title" role="img">
    ...
    <main-menu :showOnMobile.sync="showMenu" :links="links" />
  </div>
</template>
