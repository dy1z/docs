<template>
  <Layout class="bg-white antialiased font-sans leading-normal">
    <main>
      ...
      <section class="bg-white pt-20 pb-12 lg:pt-40 lg:pb-20">
        <div class="max-w-xl lg:max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
          <svg class="w-20 -mb-4" viewBox="0 0 80 60" aria-labelledby="tailwindTitle" role="img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><title id="tailwindTitle">Tailwind CSS Logo</title><defs><circle id="b" cx="38" cy="28" r="28"></circle><linearGradient x1="0%" y1="0%" y2="100%" id="c"><stop stop-color="#2383AE" offset="0%"></stop><stop stop-color="#6DD7B9" offset="100%"></stop></linearGradient></defs><g fill="none" fill-rule="evenodd"><g><use fill="#000" filter="url(#a)" xlink:href="#b"></use><use fill="#FFF" xlink:href="#b"></use></g><path d="M38 24c1.333-5.333 4.667-8 10-8 8 0 9 6 13 7 2.667.667 5-.333 7-3-1.333 5.333-4.667 8-10 8-8 0-9-6-13-7-2.667-.667-5 .333-7 3zM28 36c1.333-5.333 4.667-8 10-8 8 0 9 6 13 7 2.667.667 5-.333 7-3-1.333 5.333-4.667 8-10 8-8 0-9-6-13-7-2.667-.667-5 .333-7 3z" fill="url(#c)" transform="translate(-10 0)"></path></g></svg>
          <header class="pb-8">
            <h2 class="font-bold text-2xl">Tailwind CSS</h2>
            <p class="text-gray-600">Who said CSS frameworks should only be used for websites?</p>
          </header>
          <article class="px-4 lg:px-72 leading-loose">
            <p class="text-gray-700">
              Maizzle uses the <g-link href="https://tailwindcss.com" class="text-ocean hover:text-ocean-dark">Tailwind CSS framework</g-link>, so you can rapidly prototype HTML emails just by adding classes to your markup.
              Once satisfied with the dev preview, build for production to generate clean HTML with inlined styles and many other, email-specific optimizations.
            </p>
          </article>
        </div>
      </section>
      ...
      <section class="bg-white">
        <div class="max-w-xl lg:max-w-7xl mx-auto px-4 pb-12 lg:pb-20 flex flex-col items-center text-center">
          <svg class="fill-current w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><defs><linearGradient id="linear1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#5f54f1"/><stop offset="1000%" stop-color="#4398ee"/></linearGradient></defs><path fill="url(#linear1)" d="M.7 9.3l4.8-4.8 1.4 1.42L2.84 10l4.07 4.07-1.41 1.42L0 10l.7-.7zm18.6 1.4l.7-.7-5.49-5.49-1.4 1.42L17.16 10l-4.07 4.07 1.41 1.42 4.78-4.78z"/></svg>
          <header class="pb-8">
            <h2 class="font-bold text-2xl">BYOHTML</h2>
            <p class="text-gray-600">Markup you already know, no need to learn custom tags and attributes</p>
          </header>
          <article class="px-4 lg:px-72 leading-loose">
            <p class="text-gray-700">
      ...
      <section class="bg-white">
        <div class="max-w-xl lg:max-w-7xl mx-auto px-4 pb-16 lg:pb-20 flex flex-col items-center text-center">
          <svg class="w-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><defs><linearGradient id="linear2" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#5f54f1"/><stop offset="1000%" stop-color="#4398ee"/></linearGradient></defs><path fill="url(#linear2)" d="M3.94 6.5L2.22 3.64l1.42-1.42L6.5 3.94c.52-.3 1.1-.54 1.7-.7L9 0h2l.8 3.24c.6.16 1.18.4 1.7.7l2.86-1.72 1.42 1.42-1.72 2.86c.3.52.54 1.1.7 1.7L20 9v2l-3.24.8c-.16.6-.4 1.18-.7 1.7l1.72 2.86-1.42 1.42-2.86-1.72c-.52.3-1.1.54-1.7.7L11 20H9l-.8-3.24c-.6-.16-1.18-.4-1.7-.7l-2.86 1.72-1.42-1.42 1.72-2.86c-.3-.52-.54-1.1-.7-1.7L0 11V9l3.24-.8c.16-.6.4-1.18.7-1.7zM10 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/></svg>
          <header class="pb-8">
            <h2 class="font-bold text-2xl">Build Environments</h2>
            <p class="text-gray-600">Distinct settings for any number of build scenarios</p>
          </header>
          <article class="px-4 lg:px-72 leading-loose">
            <p class="text-gray-700">
              Define custom settings for as many build scenarios as you need by simply duplicating the default <code class="shiki-inline">config.js</code>.
      ...
      <section id="features" class="bg-gray-200 py-12 lg:py-16">
        <div class="max-w-7xl mx-auto px-4">
          <header class="mb-12 lg:mb-16 text-center">
            <h2 class="font-bold text-3xl">Maizzle Features</h2>
            <p class="text-gray-600">Customizable tools, crafted for email development</p>
          </header>
          <ul class="flex flex-wrap justify-center -mx-4 mb-12 lg:mb-16 text-gray-900">
            <li v-for="feature in features" :key="feature.path" class="w-full lg:w-1/3 p-4 sm:mx-16 md:mx-32 lg:mx-0">
              <g-link :to="feature.path" class="feature-link">
                {{ feature.title }}
                <span class="font-normal block mt-2 text-gray-600" v-html="feature.description" />
              </g-link>
            </li>
          </ul>
