<template>
  <Layout class="bg-white antialiased font-sans leading-normal">
    <main>
      <section class="bg-gradient-b-code">
        <div class="relative sbg-code-dark overflow-hidden">
          ...
          <div x-data="{ open: false }" class="relative pt-6 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
            <div class="max-w-screen-xl mx-auto px-4 sm:px-6">
              <nav class="relative flex items-center justify-between sm:h-20 md:justify-centers">
                ...
                <div class="hidden md:absolute md:flex md:items-center md:justify-end md:inset-y-0 md:right-0">
                  <a href="#" class="font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Docs</a>
                  <a href="#" class="ml-10 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Guides</a>
                  <a href="#" class="ml-10 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">Starters</a>
                  <a href="#" class="ml-10 font-medium text-gray-500 hover:text-gray-900 focus:outline-none focus:text-gray-900 transition duration-150 ease-in-out">GitHub</a>
                </div>
              </nav>
            </div>
              ...
              <div class="rounded-lg shadow-md transition transform origin-top-right" x-show="open">
                <div class="rounded-lg bg-white shadow-xs overflow-hidden">
                  <div class="px-5 pt-4 flex items-center justify-between">
                    <div>
                      <img class="h-8 w-auto" src="/images/maizzle.svg" alt="Maizzle">
                    </div>
                    <div class="-mr-2">
            ...
            <div class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
              <div class="text-center">
                <h2 class="text-4xl tracking-tighter leading-10 font-semibold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
                  <span class="font-light">Framework for </span>
                  <br class="xl:hidden" />
                  <span class="text-gradient-l-ocean-light">Rapid Email Prototyping</span>
                </h2>
                ...
                <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
                  <div class="rounded-md shadow">
                    <a href="#" class="group w-full flex items-center justify-center px-8 py-3 text-base leading-6 font-medium rounded-md text-white hover:text-blue-50 bg-gradient-l-ocean-light focus:outline-none focus:shadow-outline-indigo transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                      Get started <span class="text-2xl leading-5 ml-1 group-hover:ml-3 transition-all duration-150">&rarr;</span>
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="bg-gray-b-code hidden sm:block">
          <div class="pb-12 bg-white sm:pb-16">
            <div class="relative">
              <div class="absolute inset-0 h-1/2 bg-code"></div>
                  ...
                  <div class="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                    <g-link to="/docs/cli/">
                      <div class="border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                        <p class="text-5xl leading-none font-extrabold text-blue-500">
                          <svg class="fill-current w-6 lg:w-10 h-20 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            <defs><linearGradient id="linear1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#5f54f1"></stop><stop offset="1000%" stop-color="#4398ee"></stop></linearGradient></defs>
                            <path fill="url(#linear1)" d="M0 3c0-1.1.9-2 2-2h16a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3zm2 2v12h16V5H2z"/>
                          </svg>
                        </p>
                    ...
                    <g-link to="/docs/introduction/">
                      <div class="border-t border-b border-gray-100 p-6 text-center sm:border-0 sm:border-l sm:border-r">
                        <p class="text-5xl leading-none font-extrabold text-indigo-600">
                          <svg class="fill-current w-6 lg:w-10 mx-auto h-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path fill="url(#linear1)" d="M.7 9.3l4.8-4.8 1.4 1.42L2.84 10l4.07 4.07-1.41 1.42L0 10l.7-.7zm18.6 1.4l.7-.7-5.49-5.49-1.4 1.42L17.16 10l-4.07 4.07 1.41 1.42 4.78-4.78z"></path></svg>
                        </p>
                        <p class="mt-2 text-lg leading-6 font-medium text-gray-500">
                          Framework
                        </p>
                    ...
                    <g-link to="/docs/starters/">
                      <div class="border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                        <p class="text-5xl leading-none font-extrabold text-indigo-600">
                          <svg class="fill-current w-6 lg:w-10 mx-auto h-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path fill="url(#linear1)" d="M13 8V0L8.11 5.87 3 12h4v8L17 8h-4z"></path></svg>
                        </p>
                        <p class="mt-2 text-lg leading-6 font-medium text-gray-500">
                          Starters
                        </p>
          ...
          <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
                    ...
                    <li>
                      <div class="flex">
                        ...
                        <div class="ml-4">
                          ...
                          <p class="mt-2 text-base leading-6 text-gray-500">
                            Maizzle doesn't require learning custom syntax: you write your own, real HTML. We don't hardcode components in the framework core 🤙
                          </p>
                        </div>
                      </div>
                    </li>
            ...
            <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
              <div class="relative">
                ...
                <p class="mt-3 text-lg leading-7 text-gray-500">
                  Custom build scenarios, easily configured through JavaScript objects. Using fake data locally, but fetching from an API when staging? Prettified markup for your colleagues, but minified for production?
                  <br><br>
                  All possible.
                </p>
      ...
      <section>
        <div class="py-12 bg-gradient-l-code">
          <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-screen-xl lg:px-8">
            ...
            <div class="lg:grid lg:grid-cols-3 lg:gap-8 mt-10 lg:mt-24">
              <div
                class="bg-white rounded hover:shadow-xl transition-shadow duration-150"
                v-for="(feature, index) in features"
                :key="index"
                :class="{'mt-6': index > 0}"
              >
                <g-link :to="feature.path">
                  <div class="p-6">
                    <h5 class="text-lg leading-6 font-medium text-gray-900">{{ feature.title }}</h5>
                    <p class="mt-2 text-base leading-6 text-gray-500" v-html="feature.description" />
                  </div>
                </g-link>
              </div>
            </div>
          ...
          <div class="relative max-w-lg mx-auto lg:max-w-7xl">
            <div>
              ...
              <div class="mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-center">
                ...
                <div class="mt-6 flex lg:mt-0 lg:justify-end">
                  <g-link to="/guides/" class="group flex items-center justify-center px-4 py-2 text-base leading-6 font-medium rounded-md text-white hover:text-blue-50 bg-gradient-l-ocean-light focus:outline-none focus:shadow-outline-indigo transition duration-150 ease-in-out md:py-3 md:text-lg md:px-6">
                    View all <span class="text-2xl leading-5 ml-1 group-hover:ml-3 transition-all duration-150">&rarr;</span>
                  </g-link>
                </div>
              </div>
            </div>
            <div class="mt-6 grid gap-16 border-t-2 border-gray-100 pt-10 lg:grid-cols-2 lg:col-gap-5 lg:row-gap-12">
              <div v-for="edge in $page.tutorials.edges" :key="edge.node.id">
                ...
                <div class="mt-3">
                  <g-link :to="edge.node.path" class="text-base leading-6 font-semibold text-ocean-darker hover:text-ocean-dark transition ease-in-out duration-150">
                    Read tutorial &rarr;
                  </g-link>
                </div>
              </div>
      ...
      <section>
        <div class="bg-white">
          <div class="max-w-screen-xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-32 lg:px-8">
            <h2 class="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
              Start building awesome emails
            </h2>
            <p class="mt-4 max-w-2xl text-lg leading-7 text-gray-500 lg:mx-auto">
  ...
  <div class="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
    ...
    <div class="mt-8">
      <p class="text-center text-base leading-6 text-gray-400">
        &copy; 2020 Maizzle - Made with ❤ for email, <g-link to="https://github.com/maizzle/maizzle">open sourced</g-link> under the MIT license.
      </p>
    </div>
  </div>
</div>
  ...
  metaInfo () {
    return {
      ...
      meta: [
        ...
        { property: "og:title", content: 'Maizzle - Framework for Rapid Email Prototyping' },
        { property: "og:description", content: this.$static.metadata.siteDescription },
        { property: "og:url", content: this.$static.metadata.siteUrl },
        { property: "og:image", content: this.ogImageUrl },

        { name: "twitter:card", content: "summary_large_image" },
        { name: "twitter:title", content: 'Maizzle - Framework for Rapid Email Prototyping' },
