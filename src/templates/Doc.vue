  ...
  metaInfo () {
    return {
      ...
      meta: [
        ...
        { property: "og:title", content: `${this.$page.doc.title} | Maizzle - Framework for Rapid Email Prototyping` },
        ...
        { name: "twitter:title", content: `${this.$page.doc.title} | Maizzle - Framework for Rapid Email Prototyping` },
