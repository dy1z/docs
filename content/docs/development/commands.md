...
You can then preview your templates by visiting http&zwnj;://localhost:3000 in a browser.

You can edit a Template in your code editor, save it, and the changes will be almost instantly reflected in the browser. And, of course, you can also [configure BrowserSync](/docs/build-config/#browsersync).
...
Also, if you're editing a Template, Maizzle will only re-compile _that_ Template, so changes are usually reflected in under a second. This does not apply, however, when editing other files that have a global impact, like Layouts, Components, or your Tailwind config.
