...
Also, if you're editing a Template, Maizzle will only re-compile _that_ Template, so changes are usually reflected in under a second.

When making changes to files that have a global impact, like Layouts or Components, Maizzle will re-compile all Templates.
